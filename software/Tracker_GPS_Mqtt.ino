...
const char apn[]  = "internet.orange.ma";
const char user[] = "";
const char pass[] = "";

const char* broker = "demo.thingsboard.io";//"demo.thingsboard.io"
const char * token = "UJvRYEGp7buo3HZifREE"; // From thingsboard.io device
//const char* topic_GPS = "v1/devices/me/telemetry";
